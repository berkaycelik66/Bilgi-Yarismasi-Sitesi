...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        ...
        .auto-style5 {
            overflow: auto;
            top:0px;
            max-height: 250px; /* Set the maximum height for the table container */
        }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlPoints" runat="server">
        <div class="auto-style5">
            <div class="table">
                <div class="table-header" style="position:sticky; top:0px; z-index:10;">
    ...
    <asp:Panel ID="pnlQuestions" runat="server">
        ...
        <div class="auto-style5">
            <table class="table2">
                <tr class="table2-header" style="position:sticky; top:0px; z-index:10;">
                    <td>Kategori</td>
