    ...
    <table class="table2" border="0">
        ...
        <asp:Repeater ID="rpt1" runat="server">
            <ItemTemplate>
                ...
                <tr class="table2-row">
                    <td><%#Eval("category")%></td>
                    <td style="width:400px;"><%#Eval("question")%></tdstyle="max-width:100px;>
